...
INTERVALO_POLLINATIONS = 8 if POLLINATIONS_TOKEN else 18
...
TEMAS = [
    ...
    "a Dança da Peste de 1518 em Estrasburgo, onde centenas de pessoas dançaram incontrolavelmente até morrer de exaustão",
    "o Sínodo do Cadáver: em 897, o Papa Estêvão VI mandou desenterrar o corpo do Papa Formoso e o colocou em julgamento por traição",
    "Tarrare, o soldado francês que comia objetos vivos, gatos, cobras e até um bebê inteiro, e nunca saciava sua fome",
    "a Grande Inundação de Melado de Boston em 1919, onde 2,3 milhões de galões de melaço arrasaram ruas matando 21 pessoas",
    "Tsutomu Yamaguchi, o homem que sobreviveu à bomba de Hiroshima, pegou um trem para Nagasaki e sobreviveu à segunda bomba",
    "o evento de Tunguska em 1908, uma explosão tão poderosa que arrasou 80 milhões de árvores na Sibéria, sem cratera ou meteorito encontrado",
    "o Grande Roubo da Cerveja na Inglaterra em 1814, onde um tanque de 1 milhão de litros de cerveja arrebentou e afogou 8 pessoas",
    "a história dos irmãos Collyer, dois reclusos de Nova York que viveram entre 140 toneladas de lixo e morreram soterrados em sua própria casa",
    "o Homem de Somerton, um cadáver encontrado em uma praia australiana em 1948 com um papel no bolso escrito 'Tamam Shud' e até hoje não identificado",
    "a Guerra do Emu na Austrália em 1932, onde o exército perdeu para 20.000 emus usando metralhadoras e tiveram que recuar",
    "o falso profeta e alquimista Cagliostro, que enganou a realeza europeia com elixires da juventude e foi preso pela Inquisição",
    "a lenda do Conde de St. Germain, um misterioso cortesão que alegava ter 500 anos e nunca era visto comendo ou bebendo em público",
    "o funeral vitoriano onde as pessoas usavam broches feitos com cabelo dos mortos e realizavam sessões de fotos pós-morte com os corpos posando",
    "as crianças verdes de Woolpit, dois irmãos de pele esverdeada que surgiram em uma vila inglesa no século XII e falavam uma língua desconhecida",
    "o Flautista de Hamelin, baseado em um evento real onde 130 crianças sumiram em 1284, e registros históricos confirmam o desaparecimento",
    "Rasputin, que sobreviveu a veneno, três tiros e foi amarrado, jogado no rio Nevsky e ainda agonizou até se afogar 8 minutos depois",
    "a Maldição de Tutancâmon: a morte misteriosa de Lord Carnarvon e outros 20 envolvidos na abertura da tumba em 1922, atribuída a fungos ou maldição",
    "o incêndio da Biblioteca de Alexandria, que destruiu milhares de pergaminhos, mas ninguém sabe ao certo quem queimou e quantos se perderam",
    "a Batalha de Los Angeles em 1942, onde o exército americano disparou 1.400 tiros contra um objeto voador não identificado que nunca foi explicado",
    "o experimento Filadélfia, a lenda de que um navio da marinha americana foi teletransportado e seus tripulantes ficaram fundidos no casco",
    "o projeto Montauk, uma suposta base militar onde experimentos de viagem no tempo e controle mental foram realizados nos anos 1970",
    "a criatura Mothman, avistada em Point Pleasant em 1966, uma figura alada de olhos vermelhos que precedeu o colapso de uma ponte matando 46 pessoas",
    "o som de 'UVB-76' ou 'The Buzzer', uma estação de rádio russa que emite zumbidos 24/7 desde 1982 e de vez em quando transmite mensagens cifradas",
    "o sinal Wow! captado em 1977 por um radiotelescópio, um sinal de 72 segundos tão forte que o astrônomo escreveu 'Wow!' e até hoje não foi repetido",
    "a peste negra na Europa, onde médicos usavam máscaras de bico com ervas para 'filtrar' o ar, acreditando que a doença vinha do mau cheiro (teoria miasmática)",
    "o vampiro de Highgate, um suposto vampiro avistado no cemitério de Londres em 1960, que gerou caça aos vampiros com estacas e crucifixos",
    "a boneca Annabelle real, uma boneca Raggedy Ann que segundo a família era controlada por um espírito, e hoje está trancada em um recipiente no Museu do Oculto",
    "o caso de Michael Malloy, um homem que sobreviveu a várias tentativas de assassinato (envenenamento, atropelamento, etc.) na década de 1930, virando lenda",
    "os Titãs de Mont' Pelerin, uma suposta raça de gigantes que teria habitado a Patagônia e deixado pegadas e ossos enormes na Patagônia",
    "a profecia de São Malaquias, que listou 112 papas e acertou as descrições até o Papa Francisco, o último antes do apocalipse segundo a lenda",
    "o gato fumante de Sigmund Freud, que segundo o próprio psicanalista, seu gato Jofi participava de sessões de análise com os pacientes",
    "a guerra dos porcos (The Pig War) de 1859, onde EUA e Inglaterra quase entraram em guerra por causa de um porco abatido em uma ilha",
    "o caso do fantasma de Berkeley Square, uma mansão em Londres onde um fantasma supostamente aterrorizava os moradores a ponto de um morador se jogar pela janela",
    "a história do homem que vendeu a Torre Eiffel duas vezes (Victor Lustig), um golpista que fingiu ser funcionário do governo e vendeu o monumento para sucateiros",
    "a maldição de Kennedy: a família Kennedy teve mortes trágicas em sequência, incluindo assassinos, acidentes de avião e overdoses, atribuídas a uma maldição",
    "os gatos na Idade Média, que eram caçados e mortos por serem associados a bruxas, o que contribuiu para a proliferação da peste preta (ratos)",
    "a rainha Maria I da Inglaterra (Maria Sangrenta), que queimou mais de 280 protestantes na fogueira por se recusarem a se converter ao catolicismo",
    "o Manuscrito Voynich, um livro do século XV escrito em uma língua ou código totalmente indecifrável, cheio de plantas e diagramas que não existem na natureza",
    "a morte de Mozart, envolta em mistério e conspiração, onde alguns acreditam que Salieri o envenenou, mas a causa oficial foi febre reumática",
    "a guerra dos 100 anos teve uma batalha onde os franceses foram derrotados por arqueiros galeses, e os franceses cortavam os dedos indicadores dos prisioneiros",
    "a explosão de Halifax em 1917, a maior explosão artificial antes de Hiroshima, onde dois navios colidiram e devastaram a cidade matando 2.000 pessoas",
    "o caso do zumbi na Louisiana, onde em 1980 um homem chamado Clairvius Narcisse foi declarado morto, enterrado e reapareceu 18 anos depois dizendo que foi mantido como escravo zumbi"
